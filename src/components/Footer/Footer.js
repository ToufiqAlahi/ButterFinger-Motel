...
const Footer = () => {
  return (
    <section className="bg-[#f1f1f1]  md:mt-28 relative bottom-0 mt-60">
      <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="text-center text-gray-700  flex flex-col md:flex-row gap-10 md:gap-56 justify-center items-center ">
          <a
            rel="noreferrer"
            target="_blank"
          ...
          >
            © 2021 Copyright:
            <b className="gradient-text"> Toufiq Alahi 🡭 </b>, Sylhet,
